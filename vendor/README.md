...
- `vendor/ghostty/` — git submodule of `ghostty-org/ghostty` (MIT), pinned to `b0c421fcd2e290629d4285c181b52fe2f2095f06` (untagged `origin/main`, post-`v1.3.1`; see docs/ghostty-integration.md for pin provenance).
